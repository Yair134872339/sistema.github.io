            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">FB de la institucion:&copy; <a href="https://www.facebook.com/TecNMCampusITSMIGRA" target="_blank" rel="noopener noreferrer">ITSMIGRA </a> <?php echo date("Y"); ?></div>
                        <div>
                            <a href="#">#Familia_Tics</a>
                            &middot;
                            <a href="#">&amp;</a>
                        </div>
                    </div>
